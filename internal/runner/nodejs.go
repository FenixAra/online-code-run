...
func NewNodejsRunner() *NodejsRunner {
	return &NodejsRunner{}
}

func (n *NodejsRunner) Run(req *dtos.APIReq) *dtos.APIRes {
	res := &dtos.APIRes{}
	p := "/tmp/ocr/" + req.ID
	...
	cmd := exec.Command("node", p+"/"+req.Name)
...
func (n *NodejsRunner) Compile(req *dtos.APIReq) *dtos.APIRes {
	return nil
}
